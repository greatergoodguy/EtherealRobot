...
// 
// 
public class InputTesterPlayerCH : MonoBehaviour{
	// crosshair texture
	...
	{		
		...
		InputTesterPlayerPC.AllowMouseRotation = false;
		...
		if ((ImageCrosshair != null) && (FadeVal != 0.0f))
		{
			...
			InputTesterPlayerPC.AllowMouseRotation = true;
			...
			// Finally draw cursor
			if(InputTesterPlayerPC.AllowMouseRotation == true)
			{
				// Left
