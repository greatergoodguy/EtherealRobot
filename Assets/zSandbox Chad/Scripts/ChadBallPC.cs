...
// by the player.
//
public class ChadBallPC : PlayerController {
	...
	private static Vector3 screenPoint = new Vector3(250, 200, 20);
	private static Vector3 worldPos = Camera.main.ScreenToViewportPoint(screenPoint);
	public Texture whatever;
	public float moveAmt = .01f;
