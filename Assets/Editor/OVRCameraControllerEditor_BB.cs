...
[CustomEditor(typeof(OVRCameraController_BB))]
...
//
public class OVRCameraControllerEditor_BB : Editor
{
	// target component
	private OVRCameraController_BB m_Component;

	// OnEnable
	void OnEnable()
	{
		m_Component = (OVRCameraController_BB)target;
	}
	...
	public override void OnInspectorGUI()
	{
		...
		Undo.SetSnapshotTarget(m_Component, "OVRCameraController_BB");
