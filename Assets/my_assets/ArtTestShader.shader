Shader "ArtTestShader"
{
	Properties 
	{
_Diffuse("_Diffuse", 2D) = "gray" {}
_Normal("_Normal", 2D) = "bump" {}
_SoecularGloss("_SoecularGloss", 2D) = "black" {}
...
float4 Tex2D2=tex2D(_Emmisive,(IN.uv_Emmisive.xyxy).xy);
float4 Tex2D1=tex2D(_SoecularGloss,(IN.uv_SoecularGloss.xyxy).xy);
