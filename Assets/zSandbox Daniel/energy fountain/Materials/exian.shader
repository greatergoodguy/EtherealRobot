Shader "exian"
{
	Properties 
	{
_Diffuse("explorer", 2D) = "gray" {}
_Normal("_Normal", 2D) = "bump" {}
_Specular("_Specular", 2D) = "black" {}
_EmmisiveMask("_EmmisiveMask", 2D) = "black" {}
_DimGlow("_DimGlow", Color) = (0.166908,0.7173454,0.8283582,1)
_brightglow("_brightglow", Color) = (0.1151704,0.4062814,0.7014925,1)
...
float4 Clamp0=clamp(_SinTime,float4( 0,0,0,0 ),float4( 1,1,1,1 ));
float4 Lerp0=lerp(_brightglow,_DimGlow,Clamp0);
float4 Tex2D2=tex2D(_EmmisiveMask,(IN.uv_EmmisiveMask.xyxy).xy);
float4 Multiply0=Lerp0 * Tex2D2;
