...
public class XboxInput : Input_BB {
	...
	public override bool GetButton_Look() {			return Input.GetKey(KeyCode.JoystickButton4);}  
	...
	public override float GetAxis_MouseY() {						return Input.GetAxis("Xbox_Vertical");}
