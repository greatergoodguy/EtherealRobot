...
public class XboxInput : Input_BB {
	public override bool GetButton_Accel() {		return Input.GetKey(KeyCode.Joystick1Button5);}  
	...
	public override bool GetButton_RotateBodyLeft(){	return Input.GetKey(KeyCode.JoystickButton2);}  
	public override bool GetButton_RotateBodyRight() {	return Input.GetKey(KeyCode.JoystickButton1);}
	...
	public override bool GetButtonDown_CycleActivePlayer() {		return Input.GetKeyDown(KeyCode.B);}
