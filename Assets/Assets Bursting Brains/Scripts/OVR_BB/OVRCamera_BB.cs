...
//
public class OVRCamera_BB : OVRComponent_BB{		
	// PRIVATE MEMBERS
	...
	private OVRCameraController_BB CameraController = null;
...
// * * * * * * * * * * * * *
	...
	new void Start()
	{
		...
		CameraController = gameObject.transform.parent.GetComponent<OVRCameraController_BB>();
