...
// 
// 
public class OVRCrosshair_BB : MonoBehaviour
{
	// crosshair texture
	...
	{		
		...
		OVRPlayerController_BB.AllowMouseRotation = false;
		...
		if ((ImageCrosshair != null) && (FadeVal != 0.0f))
		{
			...
			OVRPlayerController_BB.AllowMouseRotation = true;
			...
			// Finally draw cursor
			if(OVRPlayerController_BB.AllowMouseRotation == true)
			{
				// Left
