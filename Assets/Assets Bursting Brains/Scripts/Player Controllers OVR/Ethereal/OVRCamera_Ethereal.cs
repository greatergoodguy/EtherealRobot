...
public class OVRCamera_Ethereal : OVRComponent {		
	// PRIVATE MEMBERS
	...
	private OVRCameraController_Ethereal CameraController = null;
...
// * * * * * * * * * * * * *
	...
	new void Start()
	{
		...
		CameraController = gameObject.transform.parent.GetComponent<OVRCameraController_Ethereal>();
