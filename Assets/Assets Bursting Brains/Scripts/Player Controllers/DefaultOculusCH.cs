...
// 
// 
public class DefaultOculusCH : MonoBehaviour{
	// crosshair texture
	...
	{		
		...
		DefaultOculusPC.AllowMouseRotation = false;
		...
		if ((ImageCrosshair != null) && (FadeVal != 0.0f))
		{
			...
			DefaultOculusPC.AllowMouseRotation = true;
			...
			// Finally draw cursor
			if(DefaultOculusPC.AllowMouseRotation == true)
			{
				// Left
