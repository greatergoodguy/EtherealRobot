...
// 
// 
public class BasicMovementCH : MonoBehaviour
{
	// crosshair texture
	...
	{		
		...
		BasicMovementPC.AllowMouseRotation = false;
		...
		if ((ImageCrosshair != null) && (FadeVal != 0.0f))
		{
			...
			BasicMovementPC.AllowMouseRotation = true;
			...
			// Finally draw cursor
			if(BasicMovementPC.AllowMouseRotation == true)
			{
				// Left
