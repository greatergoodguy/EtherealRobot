...
// 
// 
public class FloatingSphereCH : MonoBehaviour
{
	// crosshair texture
	...
	{		
		...
		FloatingSpherePC.AllowMouseRotation = false;
		...
		if ((ImageCrosshair != null) && (FadeVal != 0.0f))
		{
			...
			FloatingSpherePC.AllowMouseRotation = true;
			...
			// Finally draw cursor
			if(FloatingSpherePC.AllowMouseRotation == true)
			{
				// Left
