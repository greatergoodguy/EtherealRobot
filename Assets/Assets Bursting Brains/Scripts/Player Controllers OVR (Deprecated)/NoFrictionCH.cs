...
// 
// 
public class NoFrictionCH : MonoBehaviour
{
	// crosshair texture
	...
	{		
		...
		NoFrictionPC.AllowMouseRotation = false;
		...
		if ((ImageCrosshair != null) && (FadeVal != 0.0f))
		{
			...
			NoFrictionPC.AllowMouseRotation = true;
			...
			// Finally draw cursor
			if(NoFrictionPC.AllowMouseRotation == true)
			{
				// Left
